...
2) Included log file 
3) Time and memory options
4) Log file keeps record of sample to job id mapping
5) Accepts user provided gff file
6) If the tophat output dir already exists for a sample and has align_summary file, it does not rerun the job for this sample
'''
